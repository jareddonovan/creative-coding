 ...
 *  NOTE:  this file has been modified since downloaded from the web  (version?)
 *  if you replace it with a newer version, please either: apply the fix billr made to getDeltaToElement or test that scrollTo does not cause infinite loop.
 *  scrollTo is invoked by the course theme/structure pickers when the user navigates the themes/structures using the up/down arrows.
 */
...
// NOTE:  getContainerOffset causes an infinite loop, replace with element.positionedOffset.  billr.
